...
public class PanelOngletAdministrateur extends JPanel implements Observer{
	...
	private ThreadModeOuvert threadModeOuvert;
	...
	public PanelOngletAdministrateur() {
		...
		controlGestionMoteurAdmin.initialisationLogiciel();
	...
	public void initOngletAdmin() {
		...
		boxOngletAdmin.add(verticalStrut_4);
		...
		boxParamImage.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		boxParamImage.add(verticalGlue_4);
		
		//Partie Texte
		
		Box boxParamTexte = Box.createVerticalBox();
		boxParamTexte.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		boxParamTexte.add(verticalGlue_1);
		
		//Partie Son
		
		Box boxParamSon = Box.createVerticalBox();
		boxParamSon.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		boxParamSon.add(verticalGlue_3);
		...
		boxActions.add(verticalStrut_5);
		
		JCheckBox chckbxNewCheckBox = new JCheckBox("Activer mode ouvert");
		chckbxNewCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(chckbxNewCheckBox.isSelected())
				{
					if(threadModeOuvert == null) {
						threadModeOuvert = new ThreadModeOuvert();
					}
					if(!(threadModeOuvert.isAlive())){
						threadModeOuvert = new ThreadModeOuvert();
		...
		boxActions.add(chckbxNewCheckBox);
		
		Component verticalGlue_2 = Box.createVerticalGlue();
		boxActions.add(verticalGlue_2);
	}
	...
	public void initOngletModif() {
		...
		boxModifier.add(verticalStrut_1);
	...
	public void update(Observable o, Object arg) {
		if((o instanceof Moteur) && (arg instanceof Integer[])) {
