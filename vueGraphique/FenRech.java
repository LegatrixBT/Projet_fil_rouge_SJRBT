...
public class FenRech extends JFrame {
	...
	public FenRech() {
		...
		panelFinalInteg.setBounds(0, 0, 635, 400);
		getContentPane().add(panelFinalInteg);
		panelFinalInteg.setLayout(null);
		...
		Choix.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{horizontalBox, horizontalGlue_3, rdbtnmntmTexte_1, horizontalGlue_1, rdbtnmntmImage, horizontalGlue, rdbtnmntmSon, horizontalGlue_2}));
		...
		try {
		    img = ImageIO.read(new File("src/questions.jpg"));
		} catch (IOException e) {
		    e.printStackTrace();
		}
		...
		try {
		    img2 = ImageIO.read(new File("src/questions.jpg"));
		} catch (IOException e) {
		    e.printStackTrace();
		}
